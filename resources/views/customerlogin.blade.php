...
<head>
  ...
  <title>Customer Login - Rentalz</title>
...
<body class="font-sans flex items-center justify-center min-h-screen">
  ...
  <div class="w-full max-w-md bg-white rounded-2xl shadow-xl p-8">
    ...
    <div class="mb-8 text-center">
      ...
      <h2 class="text-3xl font-bold text-indigo-700">Customer Login</h2>
    ...
    <p class="mt-6 text-center text-gray-700 text-sm">
      ...
      <a href="{{ route('customer.register.form') }}" class="text-indigo-600 hover:underline font-semibold">
        Register here
      </a>
    </p>
